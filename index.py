...
class ContactsIndex:
    def __init__(self):  
        self.contacts_by_id = {} # I store contacts in a dictionary using their ID
        self.contacts_by_phone = {} # one to find contacts by phone
        self.trie = Trie()
        self.next_id = 1
    ...
    def all_sorted_by_name(self): #return contacts sorted alphabetically 
